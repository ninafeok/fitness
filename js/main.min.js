...
var _playVideo = require("./modules/play-video/play-video");
var _tariffToggle = require("./modules/tariff-toggle");
var _initTabs = require("./modules/tabs/init-tabs");
var _sliderExpertsInit = require("./modules/slider/slider-experts-init");
var _initAccordion = require("./modules/accordion/init-accordion");
var _sliderReviewsInit = require("./modules/slider/slider-reviews-init");
var _expertsCardsActive = require("./modules/experts-cards-active");
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _playVideo.startVideo)();
    (0, _tariffToggle.changePeriod)();
    (0, _tariffToggle.changeTariff)();
    (0, _initTabs.initTabs)();
    (0, _sliderExpertsInit.sliderExpertsInit)();
    (0, _expertsCardsActive.setCardsActive)();
    (0, _initAccordion.initAccordions)();
    (0, _sliderReviewsInit.sliderReviewsInit)();
  });
});

},{"./modules/accordion/init-accordion":3,"./modules/experts-cards-active":4,"./modules/form-validate/form":6,"./modules/play-video/play-video":12,"./modules/slider/slider-experts-init":13,"./modules/slider/slider-reviews-init":14,"./modules/tabs/init-tabs":15,"./modules/tariff-toggle":17,"./utils/ios-vh-fix":19}],2:[function(require,module,exports){
"use strict";
...
var isMobile = window.matchMedia('(max-width:1365px)');
var expertCards = document.querySelectorAll('[data-slider="expert-slide"]');
var setCardsActive = exports.setCardsActive = function setCardsActive() {
  expertCards.forEach(function (card) {
    card.setAttribute('tabindex', '0');
  });
  if (isMobile.matches) {
    var _iterator = _createForOfIteratorHelper(expertCards),
      _step;
    try {
      var _loop = function _loop() {
        ...
        card.addEventListener('click', function () {
          ...
          expertCards.forEach(function (i) {
...
var baseSuccessCallback = function baseSuccessCallback(event) {
  ...
  var formData = new FormData(document.querySelector('[data-form]'));
  fetch(url, {
    method: 'POST',
    body: formData
...
exports.startVideo = void 0;
var playerWrapper = document.querySelector('[data-video="container"]');
var playBtn = document.querySelector('[data-video="play-button"]');
var poster = playerWrapper.querySelector('[data-video="container"] img');
var startVideo = exports.startVideo = function startVideo() {
...
exports.sliderExpertsInit = exports.sliderExperts = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var sliderExperts;
var prevButton = document.querySelector('[data-slider="prev-expert"]');
var nextButton = document.querySelector('[data-slider="next-expert"]');
var sliderExpertsInit = exports.sliderExpertsInit = function sliderExpertsInit() {
  exports.sliderExperts = sliderExperts = new _swiper.default('[data-slider="experts-slider"]', {
    loop: true,
    slidesPerView: 4,
    spaceBetween: 40,
    allowSlideNext: true,
...
},{"../../vendor/swiper":20}],14:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sliderReviewsInit = exports.sliderReviews = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var sliderReviews;
var prevButton = document.querySelector('[data-slider="prev-review"]');
var nextButton = document.querySelector('[data-slider="next-review"]');
var sliderReviewsInit = exports.sliderReviewsInit = function sliderReviewsInit() {
  exports.sliderReviews = sliderReviews = new _swiper.default('[data-slider="reviews-slider"]', {
    loop: false,
    slidesPerView: 1,
    spaceBetween: 800,
    centeredSlides: true,
...
exports.changeTariff = void 0;
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
var btnIndex = 0;
var controlBtns = document.querySelectorAll('[data-price="control"]');
var shownPrice = document.querySelectorAll('[data-price="value"]');
var priceShadows = document.querySelectorAll('[data-price="shadow"]');
var tariff = document.querySelectorAll('[data-price="tariff-plan"]');
var prices = [[5000, 1700, 2700], [30000, 10200, 16200], [60000, 20400, 32400]];
controlBtns.forEach(function (button, i) {
...
function changePeriod() {
  ...
  shownPrice.forEach(function (price, index) {
  ...
  priceShadows.forEach(function (price, index) {
    price.textContent = prices[btnIndex][index];
  });
}
var changeTariff = exports.changeTariff = function changeTariff() {
  tariff[1].classList.add('is-active');
  var _iterator = _createForOfIteratorHelper(tariff),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var card = _step.value;
